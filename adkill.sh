...
while [[ -n "$1" ]]
	...
	*)
		...
		echo "--fbk : activate blacklist of facebook sites (Blocking Facebook and Facebook related/owned services) listed in the BlockListProject hosts file."
		...
		echo "--prn : activate blacklist of porn sites listed in the StevenBlack & BlockListProject hosts file."
